...
Notice that CPU is set to `1024` units and memory reserved is `1000` for the docker container. The test was performed with the server running behind an ALB.
#### ECS task Definition
```json
{
  "ipcMode": null,
